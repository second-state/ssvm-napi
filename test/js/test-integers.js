...
describe('s32', function() {
  it('lcm', function() { assert.equal(lcm_s32(123, 1011), 41451); });
  it('lcm s32 overflow',
     function() { assert.notEqual(lcm_s32(2147483647, 2), 4294967294); });
});

describe('u32', function() {
  it('lcm', function() { assert.equal(lcm_u32(123, 1011), 41451); });
  it('lcm s32 overflow',
     function() { assert.equal(lcm_u32(2147483647, 2), 4294967294); });
  it('lcm u32 overflow',
     function() { assert.notEqual(lcm_u32(4294967295, 2), 8589934590); });
});

describe('s64', function() {
  it('lcm', function() { assert.equal(lcm_s64(123, 1011), 41451); });
...
describe('u64', function() {
  it('lcm', function() { assert.equal(lcm_u64(123, 1011), 41451); });
  it('lcm s64 overflow', function() {
